...
-- O trigger preenche workspace_id a partir da sessão autenticada e impede que
-- qualquer papel grave no workspace de terceiros. O cliente não escolhe tenant.
begin;
