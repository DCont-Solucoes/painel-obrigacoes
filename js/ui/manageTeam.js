...
function renderCreateUserForm() {
  return '<div class="mgmt-create-user">'
    ...
    + '</select></div>'
    + '<button class="btn-primary" type="button" data-action="user-create">+ Criar conta</button>'
...
export function renderTeamManage() {
  ...
  html += '<div class="empty" style="text-align:left;padding:14px 16px;margin-bottom:14px;">'
    + 'Crie contas novas abaixo, ou altere o <strong>papel de acesso</strong> de quem já tem conta na lista.'
    + '</div>';
